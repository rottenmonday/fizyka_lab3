...
kable(pom_tab, caption="Seria 1", format = "latex", escape = FALSE, align = 'c', col.names = c("$m_{1H_2O}$", "$T_{1H_2O}$", "$m_{2H_2O}$", "$T_{2H_2O}$", "$T_{k}$", "$c_{wk}$")) %>%
   kable_styling(position="center", latex_options = c("striped", "HOLD_position"))
```

Pierwsze pięć kolumn przedstawia dane zmierzone podczas eksperymentu. W ostatnie kolumnie zawarto obliczoną wartość ciepła właściwego kalorymetru.
...
kable(tab_niepew, caption="Seria 1 z niepewnościami", format = "latex", escape = FALSE, align = 'c', col.names = c("$m_{1H_2O}$", "$T_{1H_2O}$", "$m_{2H_2O}$", "$T_{2H_2O}$", "$T_{k}$", "$c_{wk}$", "$u(c_{wk})$")) %>%
   kable_styling(position="center", latex_options = c("striped", "HOLD_position"))
