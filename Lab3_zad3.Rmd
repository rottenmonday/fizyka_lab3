...
Ciepło właściwe jest stosunkiem potrzebnej energi do zmmieny temperatury o jeden stopień Kelwina/Celcjusza ciała o masie 1kg. 
...
Ponieważ eksperyment będzie przeprowadzany w warunkach domowych skorzystamy z dostępnych przyrządów i zastosujemy pewne uproszczenia. 
Do wyznaczenia energii dostarczonej wykorzystamy czajnik elektryczny o pewnej mocy grzałki i stoper. 
$$
Q = P * t
$$
Założymy, że cała energia pochodząca z grzałki podgrzewała wodę (100% wydajności grzałki, co jest bardzo mało prawdopodobne). 
W roli stopera użyty zostanie smartphon.
...
Czajnik użyty do gotowania wody ma moc znamionową 1850-2200W. 
Do mierzenia czasu użyto dwóch różnych smartphonów. 
Szybki eksperyment z włączeniem i wyłączeniem stopera wykazał czas reakcji człowieka na około 160 ms.
